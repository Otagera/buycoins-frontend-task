...
const mainFunc = async (login: string) => {
  try {
    ...
    const userImg: HTMLImageElement | null =
      document.querySelector(".main-profile_img");
    const userImgBig: HTMLImageElement | null =
      document.querySelector(".nav_user-img-sm");
    const userImgSm: HTMLImageElement | null =
      document.querySelector(".nav_sm-user-img");
    const usernameSm: HTMLImageElement | null =
      document.querySelector(".nav_sm-user-name");
    const displayname = document.querySelector(
      ".main-profile_data_displayname"
    );
    const username = document.querySelector(".main-profile_data_username");
